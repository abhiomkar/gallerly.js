...
App.fn.calculateRowNumbers = function() {
...
App.fn.nextImageNode = function($img) {
...
App.fn.prevImageNode = function($img) {
...
App.fn.renderPreview = function($img) {
  ...
  if (this.prevRowNum !== rowNum) {
    ...
    for (var i = rowNum + 1; i <= this.totalRows; i++) {
        var bottomRowElements = $app.querySelectorAll('.thumbnail[data-row="' + i + '"]');
